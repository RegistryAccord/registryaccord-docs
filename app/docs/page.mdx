...
To get started with RegistryAccord, you can:

- [Use the CLI](/cli) to interact with the protocol
- [Set up the Devstack](/devstack) for local development
- [Explore the Architecture](/architecture) to understand how components work together
- [Review the Specifications](/specs) for detailed protocol information
