...
- Explore the [Architecture](/docs/getting-started/architecture) to understand how components work together
- Review the [API Reference](/docs/version1/reference/apis) for detailed endpoint documentation
- Check out the [Conformance](/docs/version1/reference/conformance) documentation to understand testing
